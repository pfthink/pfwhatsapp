...
public interface HydratedTemplateButtonOrBuilder extends
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedQuickReplyButton getQuickReplyButton();
  /**
   * <code>.binary.HydratedQuickReplyButton quickReplyButton = 1;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedQuickReplyButtonOrBuilder getQuickReplyButtonOrBuilder();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedURLButton getUrlButton();
  /**
   * <code>.binary.HydratedURLButton urlButton = 2;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedURLButtonOrBuilder getUrlButtonOrBuilder();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedCallButton getCallButton();
  /**
   * <code>.binary.HydratedCallButton callButton = 3;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.HydratedCallButtonOrBuilder getCallButtonOrBuilder();

  public com.xt.pfwhatsapp.ws.binary.protos.HydratedTemplateButton.HydratedButtonCase getHydratedButtonCase();
}
