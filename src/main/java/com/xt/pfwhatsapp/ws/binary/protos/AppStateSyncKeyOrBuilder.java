...
public interface AppStateSyncKeyOrBuilder extends
   ...
   * @return The keyId.
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppStateSyncKeyId getKeyId();
  /**
   * <code>optional .binary.AppStateSyncKeyId keyId = 1;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppStateSyncKeyIdOrBuilder getKeyIdOrBuilder();
   ...
   * @return The keyData.
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppStateSyncKeyData getKeyData();
  /**
   * <code>optional .binary.AppStateSyncKeyData keyData = 2;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppStateSyncKeyDataOrBuilder getKeyDataOrBuilder();
}
