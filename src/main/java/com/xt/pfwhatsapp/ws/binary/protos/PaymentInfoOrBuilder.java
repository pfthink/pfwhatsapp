...
public interface PaymentInfoOrBuilder extends
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.PaymentInfo.PaymentInfoCurrency getCurrencyDeprecated();
   ...
   * @return The status.
   */
  com.xt.pfwhatsapp.ws.binary.protos.PaymentInfo.PaymentInfoStatus getStatus();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.PaymentInfo.PaymentInfoTxnStatus getTxnStatus();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.Money getPrimaryAmount();
  /**
   * <code>optional .binary.Money primaryAmount = 12;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.MoneyOrBuilder getPrimaryAmountOrBuilder();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.Money getExchangeAmount();
  /**
   * <code>optional .binary.Money exchangeAmount = 13;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.MoneyOrBuilder getExchangeAmountOrBuilder();
}
