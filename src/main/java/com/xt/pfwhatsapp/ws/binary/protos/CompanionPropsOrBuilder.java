...
public interface CompanionPropsOrBuilder extends
   ...
   * @return The version.
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppVersion getVersion();
  /**
   * <code>optional .binary.AppVersion version = 2;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.AppVersionOrBuilder getVersionOrBuilder();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.CompanionProps.CompanionPropsPlatformType getPlatformType();
