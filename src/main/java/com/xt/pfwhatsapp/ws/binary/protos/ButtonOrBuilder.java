...
public interface ButtonOrBuilder extends
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.ButtonText getButtonText();
  /**
   * <code>optional .binary.ButtonText buttonText = 2;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.ButtonTextOrBuilder getButtonTextOrBuilder();
   ...
   * @return The type.
   */
  com.xt.pfwhatsapp.ws.binary.protos.Button.ButtonType getType();
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.NativeFlowInfo getNativeFlowInfo();
  /**
   * <code>optional .binary.NativeFlowInfo nativeFlowInfo = 4;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.NativeFlowInfoOrBuilder getNativeFlowInfoOrBuilder();
}
