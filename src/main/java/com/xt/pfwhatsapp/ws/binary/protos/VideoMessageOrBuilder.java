...
public interface VideoMessageOrBuilder extends
   ...
   */
  java.util.List<com.xt.pfwhatsapp.ws.binary.protos.InteractiveAnnotation>
      getInteractiveAnnotationsList();
  /**
   * <code>repeated .binary.InteractiveAnnotation interactiveAnnotations = 12;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.InteractiveAnnotation getInteractiveAnnotations(int index);
  /**
   * <code>repeated .binary.InteractiveAnnotation interactiveAnnotations = 12;</code>
   */
   ...
   * <code>repeated .binary.InteractiveAnnotation interactiveAnnotations = 12;</code>
   */
  java.util.List<? extends com.xt.pfwhatsapp.ws.binary.protos.InteractiveAnnotationOrBuilder>
      getInteractiveAnnotationsOrBuilderList();
  /**
   * <code>repeated .binary.InteractiveAnnotation interactiveAnnotations = 12;</code>
   */
  com.xt.pfwhatsapp.ws.binary.protos.InteractiveAnnotationOrBuilder getInteractiveAnnotationsOrBuilder(
      int index);
   ...
   */
  com.xt.pfwhatsapp.ws.binary.protos.VideoMessage.VideoMessageAttribution getGifAttribution();
